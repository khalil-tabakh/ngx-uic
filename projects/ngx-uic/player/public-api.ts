...
export * from './src/directives/bitrate/bitrate.directive';
export * from './src/directives/caption/caption.directive';
...
export * from './src/directives/seekbar/seekbar.directive';
